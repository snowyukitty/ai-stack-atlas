...
export const companies: Company[] = [
  ...
  },
  {
    ...
    stance: 'closed',
    valuation: 'Private',
    valuationNote: { zh: '字节跳动（TikTok 母公司）', en: 'ByteDance (TikTok parent)', ja: 'ByteDance（TikTok 親会社）' },
    flagship: 'Doubao Seed 2.0',
    focus: { zh: '消费规模 + 低价云', en: 'Consumer scale + low-cost cloud', ja: '消費者規模＋低価格クラウド' },
    oneLiner: {
      zh: 'TikTok 母公司，把豆包做成中国用户最多的 AI 应用，火山引擎做成云。',
      en: "TikTok's parent turned Doubao into China's most-used AI app — and Volcano Engine into its cloud.",
      ja: 'TikTok の親会社。Doubao を中国最大級の AI アプリに、Volcano Engine をクラウドに。',
    },
    analysis: {
      zh: '2012 年创立，凭消费分发（豆包 2 亿+ 用户）与 Seed 模型家族（Seed 2.0，2026-02，对标 GPT-5.2 / Gemini 3 Pro）。火山引擎以激进低价策略领跑中国 MaaS 市场（日调用约 30 万亿 token），战略重心转向企业。',
      en: 'Founded 2012, ByteDance leverages consumer distribution (Doubao, 200M+ users) and the Seed model family (Seed 2.0, Feb 2026) positioned against GPT-5.2/Gemini 3 Pro. Its Volcano Engine cloud leads China\'s model-as-a-service market on an aggressive low-price strategy (~30T daily tokens), pivoting toward enterprise.',
      ja: '2012 年設立。消費者流通（Doubao 2 億+）と Seed モデル（Seed 2.0、2026-02、GPT-5.2/Gemini 3 Pro に対抗）。Volcano Engine は積極的な低価格で中国 MaaS 首位（日 約 30 兆 token）、企業へ軸足。',
    },
    strengths: [
      { zh: '消费分发：豆包 2 亿+ 用户', en: 'Consumer distribution: Doubao 200M+ users', ja: '消費者流通：Doubao 2 億+' },
      { zh: '火山引擎中国 MaaS 第一、定价激进', en: 'Volcano Engine #1 in China MaaS; aggressive pricing', ja: 'Volcano Engine が中国 MaaS 首位・低価格' },
    ],
    watch: [
      { zh: '地缘 / TikTok 政治风险', en: 'Geopolitical / TikTok overhang', ja: '地政学/TikTok リスク' },
      { zh: '前沿深度仍逊美国头部', en: 'Frontier depth still trails top US labs', ja: '前沿深度は米頂点に劣る' },
    ],
    positioning: { zh: '消费触达 + 低价云。', en: 'Consumer reach plus a low-cost cloud.', ja: '消費者リーチ＋低価格クラウド。' },
    productIds: [],
    links: [
      { label: 'ByteDance Seed', url: 'https://seed.bytedance.com' },
      { label: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/ByteDance' },
    ],
    accent: '#6478ff',
  },
  {
    ...
    stance: 'hybrid',
    valuation: 'Baidu',
    valuationNote: { zh: '百度（上市）', en: 'Baidu (public)', ja: 'Baidu（上場）' },
    flagship: 'ERNIE 5.1 (文心)',
    focus: { zh: '多模态 · 搜索 · 云', en: 'Multimodal · search · cloud', ja: '多モーダル · 検索 · クラウド' },
    oneLiner: {
      zh: '中国搜索巨头，押注多模态文心，开源 + 闭源双线。',
      en: "China's search giant, betting on multimodal ERNIE with an open + closed split.",
      ja: '中国の検索大手。多モーダル ERNIE に賭け、開＋閉の二線。',
    },
    analysis: {
      zh: '2000 年创立。文心 (ERNIE)：2.4 万亿参数、原生多模态的 5.0（2026-01）与高性价比的 5.1（2026-05，预训练成本约业界 6%）；同时开源 ERNIE 4.5 家族（Apache 2.0，0.3B–424B，10 个变体）。经百度智能云「千帆」MaaS 与搜索分发。',
      en: 'Founded 2000, Baidu ships ERNIE (文心) — the 2.4T-parameter, natively multimodal ERNIE 5.0 (Jan 2026) and the cost-efficient 5.1 (May 2026, ~6% of typical pre-training cost) — while open-sourcing the ERNIE 4.5 family (Apache 2.0, 0.3B–424B, 10 variants). Distributed via Baidu AI Cloud\'s Qianfan MaaS and its search franchise.',
      ja: '2000 年設立。ERNIE（文心）：2.4 兆パラメータで原生多モーダルの 5.0（2026-01）と高効率 5.1（2026-05、事前学習コスト約 6%）。ERNIE 4.5 系（Apache 2.0、0.3B–424B、10 種）はオープン化。Baidu AI Cloud「千帆」MaaS と検索で流通。',
    },
    strengths: [
      { zh: '原生全模态文心 5.x', en: 'Native full-modality ERNIE 5.x', ja: '原生全モーダル ERNIE 5.x' },
      { zh: '开源文心 4.5 + 千帆云 + 搜索触达', en: 'Open ERNIE 4.5 + Qianfan cloud + search reach', ja: 'オープン ERNIE 4.5＋千帆＋検索' },
    ],
    watch: [
      { zh: '历史上前沿榜单相对落后', en: 'Historically trailed on frontier benchmarks', ja: '前沿ベンチで出遅れ気味' },
      { zh: '搜索广告业务转型中', en: 'Search-ad business in transition', ja: '検索広告事業が移行中' },
    ],
    positioning: { zh: '多模态 + 搜索 + 云，该开就开。', en: 'Multimodal + search + cloud, open where it helps.', ja: '多モーダル＋検索＋クラウド、必要なら開放。' },
    productIds: [],
    links: [
      { label: 'ERNIE', url: 'https://ernie.baidu.com' },
      { label: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/Baidu' },
    ],
    accent: '#2932e1',
  },
  {
    ...
    stance: 'hybrid',
    valuation: 'Tencent',
    valuationNote: { zh: '腾讯（上市）', en: 'Tencent (public)', ja: 'Tencent（上場）' },
    flagship: 'Hunyuan 3.0 (混元)',
    focus: { zh: '微信生态 + 开源多模态', en: 'WeChat ecosystem + open multimodal', ja: 'WeChat 生態系＋開源多モーダル' },
    oneLiner: {
      zh: '微信帝国，把混元与开源多模态接进十亿级生态。',
      en: 'The WeChat empire, wiring Hunyuan and open multimodal models into a billion-user ecosystem.',
      ja: 'WeChat 帝国。Hunyuan と開放多モーダルを十億規模の生態系へ。',
    },
    analysis: {
      zh: '1998 年创立。混元 (Hunyuan) 大模型 3.0 于 2026-04 发布，重推理与企业；搭配大量开源的图像 / 视频模型 (HunyuanImage / Video) 与「元宝」助手。决定性优势是分发：微信的小程序、社交与支付。2026 年 AI 研发投入预计至少翻倍。',
      en: 'Founded 1998, Tencent pairs the Hunyuan (混元) LLM — 3.0 launched April 2026 with a reasoning/enterprise focus — with widely open-sourced image and video models (HunyuanImage/Video) and the Yuanbao assistant. Its decisive edge is distribution: WeChat\'s mini-programs, social graph and payments. AI R&D spend is set to at least double in 2026.',
      ja: '1998 年設立。Hunyuan（混元）LLM 3.0 を 2026-04 に公開（推論/企業重視）、広く開源した画像/動画モデル（HunyuanImage/Video）と Yuanbao を併走。決定打は流通：WeChat のミニプログラム・ソーシャル・決済。2026 年の AI 投資は少なくとも倍増見込み。',
    },
    strengths: [
      { zh: '微信分发（小程序 / 社交 / 支付）', en: 'Distribution via WeChat (mini-programs/social/pay)', ja: 'WeChat 流通（ミニプロ/ソーシャル/決済）' },
      { zh: '开源图像 / 视频模型强', en: 'Strong open image/video models', ja: '開源の画像/動画モデルが強い' },
    ],
    watch: [
      { zh: '大模型迭代节奏偏慢', en: 'Slower LLM cadence vs rivals', ja: 'LLM の更新が遅め' },
      { zh: '文本 LLM 深度仍在追赶', en: 'Text-LLM depth still catching up', ja: 'テキスト LLM 深度は追走中' },
    ],
    positioning: { zh: '以生态分发胜过纯模型领先。', en: 'Ecosystem distribution over a raw model lead.', ja: '生モデル優位より生態系流通。' },
    productIds: [],
    links: [
      { label: 'Hunyuan', url: 'https://hunyuan.tencent.com' },
      { label: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/Tencent' },
    ],
    accent: '#07c160',
  },
  {
