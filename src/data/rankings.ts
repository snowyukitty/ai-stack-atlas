...
export const rankings: RankList[] = [
  ...
  },
  {
    ...
    intro: {
      zh: '衡量终端智能体在真实终端任务上的表现。',
      en: 'Measures terminal agents on real terminal tasks.',
      ja: 'ターミナルエージェントの実タスク性能を測る。',
    },
    rows: [
      { rank: 1, productId: 'codex-cli', name: 'Codex CLI (GPT-5.5)', note: { zh: '83.4%', en: '83.4%', ja: '83.4%' } },
      { rank: 2, productId: 'claude-code', name: 'Claude Code (Opus 4.8)', note: { zh: '78.9%', en: '78.9%', ja: '78.9%' } },
      { rank: 3, productId: 'gemini-cli', name: 'Gemini / Antigravity (Gemini 3.1 Pro)', note: { zh: '70.7%', en: '70.7%', ja: '70.7%' } },
    ],
  ...
  },
  {
    ...
    rows: [
      { rank: 1, productId: 'claude-opus-48', name: 'Claude Opus 4.8', note: { zh: '69.2%（领先 GPT-5.5 与 Gemini 3.1 Pro）', en: '69.2% (ahead of GPT-5.5 & Gemini 3.1 Pro)', ja: '69.2%（GPT-5.5 と Gemini 3.1 Pro を上回る）' } },
    ],
  ...
  },
  {
    ...
    rows: [
      { rank: 1, productId: 'claude-opus-48', name: 'Claude Opus 4.8', note: { zh: '61.4', en: '61.4', ja: '61.4' } },
      { rank: 2, productId: 'gpt-55', name: 'GPT-5.5', note: { zh: '60.2', en: '60.2', ja: '60.2' } },
      { rank: 3, productId: 'gemini-31-pro', name: 'Gemini 3.1 Pro', note: { zh: '~57', en: '~57', ja: '~57' } },
      { rank: 4, productId: 'grok-43', name: 'Grok 4.3', note: { zh: '~53', en: '~53', ja: '~53' } },
    ],
